  ...
  const steps = [
    {
      ...
      description:
        "Entre em contato com a consultora Clarissa para entender suas necessidades e objetivos.",
    },
    {
      number: "02",
      title: "Escolha do Plano",
      description:
        "Juntos, encontramos o plano de consórcio ideal para o seu perfil financeiro e objetivo.",
    },
    {
      number: "03",
      title: "Adesão Simplificada",
      description:
        "Processo de adesão rápido e descomplicado, com documentação mínima necessária.",
    },
    {
      number: "04",
      title: "Contemplação",
      description:
        "Acompanhamento das assembleias mensais e estratégias para aumentar suas chances de contemplação.",
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg max-w-3xl mx-auto">
            Entenda o passo a passo para realizar seu sonho com o consórcio
            Embracon e a consultoria da Clarissa Mendes.
          </p>
        </div>
